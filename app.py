    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-2 sidebar d-none d-md-block">
                ...
                <div class="mt-5 pt-5 text-white-50 text-center">
                    <small>고객센터 1588-0000</small>
                </div>
            </div>
            ...
            <div class="col-md-10 main-content">
                <div class="row">
                    <div class="col-12">
                        <div class="welcome-card welcome-text">
                            <h2>안녕하세요, 김농협 고객님! 👋</h2>
                            <p class="mb-0 op-7">무엇을 도와드릴까요? AI 금융 비서가 24시간 대기중입니다.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-10">
                        <div class="chat-card">
                            <div class="chat-header">
                                <div>
                                    <i class="fas fa-robot text-primary me-2"></i> 스마트 금융 비서
                                </div>
                            ...
                            <div id="chat-window" class="chat-box">
                                <div class="text-center mb-4 text-muted">
                                    <small>{{ last_update }} 기준 금리 정보가 업데이트 되었습니다.</small>
                                </div>
                                <div class="msg-container">
                                    <div class="bot-avatar"><i class="fas fa-robot"></i></div>
                                    <div class="message bot">
                                        반갑습니다! <strong>{{ version }}</strong> AI 비서입니다.<br>
                                        예금, 대출, 환율 등 궁금한 점을 물어보세요.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="input-area">
                                <div class="d-flex">
                                    ...
                                    <button class="btn btn-primary btn-send" onclick="sendMessage()"><i class="fas fa-paper-plane"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        function sendMessage() {
            ...
            .then(data => {
                ...
                setTimeout(() => {
                    ...
                    chatWindow.scrollTop = chatWindow.scrollHeight;
                }, 300); // 0.3초 딜레이로 자연스럽게 연출
            })
            .catch(error => {
                chatWindow.innerHTML += `<div class='text-center text-danger my-3'><small>연결 상태가 불안정합니다.</small></div>`;
            });
        }
    </script>
</body>
...
@app.route('/')
def home():
    # 이제 Pod 이름 등 기술적인 변수는 HTML에 전달하지 않습니다 (또는 숨김)
...
def chat():
    ...
    logging.info(f"[Customer Query] {user_msg}") # 로그도 고객 쿼리로 변경
    ...
    if "대출" in user_msg or "금리" in user_msg:
        ...
        # v4.0으로 배포 확인을 위해 문구에 버전을 살짝 포함
